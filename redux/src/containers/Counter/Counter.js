  ...
  render() {
    return (
      <div>
        ...
        <CounterControl label="Add five" clicked={() => this.props.onAddCounter(5)} />
        <CounterControl label="Subtract five" clicked={() => this.props.onSubtractCounter(5)} />
        <hr />
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    onStoreResult: (value) => dispatch({ type: actionTypes.STORE_RESULT, value }),
