...
var _createItem = __webpack_require__(78);
...
var TodoIndex = function (_React$Component) {
  ...
  function TodoIndex(props) {
    ...
    _this.state = {
      todos: [{ label: 'First task to do' }, { label: 'Second task to do' }, { label: 'Third task to do' }, { label: 'Fourth task to do' }, { label: 'Fifth task to do' }]
    };
    return _this;
  }
...
var _createItemForm = __webpack_require__(79);
