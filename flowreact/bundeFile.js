...
var _createItem = __webpack_require__(31);
...
var App = function (_React$Component) {
  ...
  function App(props) {
    ...
    _this.state = {
      todos: [{ label: 'First task to do' }, { label: 'Secondd task to do' }, { label: 'Third task to do' }, { label: 'Fourth task to do' }, { label: 'Fifth task to do' }]
    };
    return _this;
  }
...
var _toDoItem = __webpack_require__(33);
...
var _createItemForm = __webpack_require__(32);
